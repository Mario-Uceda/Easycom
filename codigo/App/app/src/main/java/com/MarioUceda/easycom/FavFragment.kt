...
class FavFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        products.add(Product("6", "Product 6", "", "https://pbs.twimg.com/profile_images/1610557276732940288/DeKynRLF_400x400.jpg", "Description 6"))
        products.add(Product("7", "Product 7", "", "https://images.daznservices.com/di/library/DAZN_News/7c/f6/2023-03-18-alonso-f1-formula-1_lh774xonqgqs1j5qh3eaii55p.jpg?t=-167016602", "Description 7"))
        products.add(Product("8", "Product 8", "", "https://cdn-2.motorsport.com/images/mgl/6AEomeD6/s800/fernando-alonso-aston-martin-r-1.jpg", "Description 8"))
        products.add(Product("9", "Product 9", "", "https://imagenes.20minutos.es/files/image_990_v3/uploads/imagenes/2023/03/15/fernando-alonso-ya-esta-en-jeddah.jpeg", "Description 9"))
        products.add(Product("10", "Product 10", "", "https://pbs.twimg.com/profile_images/1610557276732940288/DeKynRLF_400x400.jpg", "Description 10"))
        products.add(Product("11", "Product 11", "", "https://images.daznservices.com/di/library/DAZN_News/7c/f6/2023-03-18-alonso-f1-formula-1_lh774xonqgqs1j5qh3eaii55p.jpg?t=-167016602", "Description 11"))
        products.add(Product("12", "Product 12", "", "https://cdn-2.motorsport.com/images/mgl/6AEomeD6/s800/fernando-alonso-aston-martin-r-1.jpg", "Description 12"))
        products.add(Product("13", "Product 13", "", "https://imagenes.20minutos.es/files/image_990_v3/uploads/imagenes/2023/03/15/fernando-alonso-ya-esta-en-jeddah.jpeg", "Description 13"))
        products.add(Product("14", "Product 14", "", "https://pbs.twimg.com/profile_images/1610557276732940288/DeKynRLF_400x400.jpg", "Description 14"))
        products.add(Product("15", "Product 15", "", "https://images.daznservices.com/di/library/DAZN_News/7c/f6/2023-03-18-alonso-f1-formula-1_lh774xonqgqs1j5qh3eaii55p.jpg?t=-167016602", "Description 15"))
        products.add(Product("16", "Product 16", "", "https://cdn-2.motorsport.com/images/mgl/6AEomeD6/s800/fernando-alonso-aston-martin-r-1.jpg", "Description 16"))
        ...
        prices.add(Price("Amazon", "6", "499.99"))
        prices.add(Price("Amazon", "7", "499.99"))
        prices.add(Price("Amazon", "8", "499.99"))
        prices.add(Price("Amazon", "9", "499.99"))
        prices.add(Price("Amazon", "10", "499.99"))
        prices.add(Price("Amazon", "11", "499.99"))
        prices.add(Price("Amazon", "12", "499.99"))
        prices.add(Price("Amazon", "13", "499.99"))
        prices.add(Price("Amazon", "14", "499.99"))
        prices.add(Price("Amazon", "15", "499.99"))
        prices.add(Price("Amazon", "16", "499.99"))
